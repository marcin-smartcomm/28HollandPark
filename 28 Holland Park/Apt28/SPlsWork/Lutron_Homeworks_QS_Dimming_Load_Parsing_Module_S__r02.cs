...
namespace UserModule_LUTRON_HOMEWORKS_QS_DIMMING_LOAD_PARSING_MODULE_S__R02
{
    public class UserModuleClass_LUTRON_HOMEWORKS_QS_DIMMING_LOAD_PARSING_MODULE_S__R02 : SplusObject
    {
        ...
        object IN__DOLLAR___OnChange_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                if ( Functions.TestForTrue  ( ( Functions.BoolToInt (Functions.Find( "~OUTPUT," , IN__DOLLAR__ ) == 1))  ) ) 
                    { 
                    __context__.SourceCodeLine = 178;
                    TEMP__DOLLAR__  .UpdateValue ( Functions.Remove ( "~OUTPUT," , IN__DOLLAR__ )  ) ; 
    ...
    public UserModuleClass_LUTRON_HOMEWORKS_QS_DIMMING_LOAD_PARSING_MODULE_S__R02 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
