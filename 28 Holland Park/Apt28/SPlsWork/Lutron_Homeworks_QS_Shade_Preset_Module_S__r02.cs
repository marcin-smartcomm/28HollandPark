...
namespace UserModule_LUTRON_HOMEWORKS_QS_SHADE_PRESET_MODULE_S__R02
{
    public class UserModuleClass_LUTRON_HOMEWORKS_QS_SHADE_PRESET_MODULE_S__R02 : SplusObject
    {
        ...
        object LEVEL_IN_OnChange_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                TX__DOLLAR__  .UpdateValue ( "#OUTPUT," + Functions.ItoA (  (int) ( INTEGRATION_ID  .UshortValue ) ) + ",1," + Functions.ItoA (  (int) ( I ) ) + "." + Functions.ItoA (  (int) ( J ) ) + "," + FADE_TIME__DOLLAR__ + "," + DELAY_TIME__DOLLAR__ + "\r\n"  ) ; 
    ...
    public UserModuleClass_LUTRON_HOMEWORKS_QS_SHADE_PRESET_MODULE_S__R02 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
